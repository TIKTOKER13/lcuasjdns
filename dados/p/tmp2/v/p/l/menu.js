...
│%readmore`.trimStart(),
  header: '│  「 %category 」\n│',
  body: `│ ${setinha} %cmd %islimite %isPremium`,
  footer: '│',
  after: `│
╰────────────────
`,
  ...
  try {
    ...
    let message = await prepareWAMessageMedia({ video: fs.readFileSync('./dados/videos/girl1.mp4'), gifPlayback: true }, { upload: conn.waUploadToServer })
     ...
     templateMessage: {
         hydratedTemplate: {
           ...
           hydratedButtons: [{
            ...
            {
          quickReplyButton: {
            displayText: 'Mudar Estilo do Menu 🎨',
            id: '/editar',
          }
