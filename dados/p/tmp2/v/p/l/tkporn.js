...
let handler = async(m, { conn, fetchJson, text }) => {
    ...
    const darklindo = `dappakntlll`
     ...
     anu = await porno()
     legenda = `⭔ Titulo: ${anu.title}\n\n⭔ Views: ${anu.views}\n\n⭔ Tags: ${anu.tags}\n\n⭔ Likes: ${anu.like}\n\n⭔ Dislikes: ${anu.dislike}\n\n⭔ Favorito: ${anu.favorite}\n\n⭔ Upado em: ${anu.upload}\n\n⭔ Descrição: ${anu.desc}\n\n⭔ Link: https://tikporntok.com/${anu.source}`
    conn.sendFile(m.chat, 'https://tikporntok.com/'+anu.video, '', legenda, m) 

 }
handler.help = ['Porno']
handler.tags = ['nsfw','random']
